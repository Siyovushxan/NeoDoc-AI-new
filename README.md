...
```bash
# .env.local
NEXT_PUBLIC_FIREBASE_API_KEY=AIzaSyDJAx3DMLi9o13lWAoTMA_70QcnE0puhPo
NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN=neodoc-ai.firebaseapp.com
NEXT_PUBLIC_FIREBASE_PROJECT_ID=neodoc-ai
NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET=neodoc-ai.firebasestorage.app
NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID=657925471230
NEXT_PUBLIC_FIREBASE_APP_ID=1:657925471230:web:9702facc825cbbdc7b9eaf

GOOGLE_AI_API_KEY=AIzaSyDWccIsWL3WLmKeoNY-wUnxIPiTRlrRHb8
